...
[![GoDoc](https://godoc.org/github.com/mmanjoura/adsa-cms/admin?status.svg)](https://godoc.org/github.com/mmanjoura/adsa-cms/log)
...
To translate admin interface to a new language, you could use `i18n` [https://github.com/mmanjoura/adsa-cms/i18n](https://github.com/mmanjoura/adsa-cms/i18n)
...
There are some Meta types that have been predefined, including `string`, `password`, `date`, `datetime`, `rich_editor`, `select_one`, `select_many` and so on (see full list here: [qor admin form templates](https://github.com/mmanjoura/adsa-cms/admin/tree/master/views/metas/form "qor admin form templates")). QOR Admin will auto select a type for `Meta` based on a field's data type. For example, if a field's type is `time.Time`, QOR Admin will determine `datetime` as the type.
...
Authorization in QOR Admin is based on setting Permissions per Role. QOR Admin uses [https://github.com/mmanjoura/adsa-cms/roles](https://github.com/mmanjoura/adsa-cms/roles) for Permission management, please refer to it's documentation for information on how to define Roles and Permissions.
...
There are a few plugins created for QOR already, you can find some of them at [https://github.com/mmanjoura/adsa-cms](https://github.com/mmanjoura/adsa-cms), visit them to learn more about how to extend QOR.
