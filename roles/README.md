...
[![GoDoc](https://godoc.org/github.com/mmanjoura/adsa-cms/roles?status.svg)](https://godoc.org/github.com/mmanjoura/adsa-cms/roles)

## Usage

### Permission Modes

Permission Modes are really the 'roles' in Roles. Roles has [5 default permission modes](https://github.com/mmanjoura/adsa-cms/roles/blob/master/permission.go#L8-L12):
