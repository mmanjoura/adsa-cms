...
export default () => {
	...
	*/} 
        ...
        <div className="tp-banner-container layout1">
          <div className="tp-banner">
            <ul>
              ...
              <li data-transition="fade" data-slotamount={1} data-masterspeed={1000} data-saveperformance="off" data-title="Slide"> 
                ...
                {/* LAYER NR. 4 */}
                <div className="tp-caption tp-caption1--wd-button  lfb ltt" data-x="center" data-y="center" data-voffset={160} data-speed={600} data-start={1100} data-easing="Power4.easeOut" data-endeasing="Power4.easeIn" style={{zIndex: 4}}><a href="#" className="btn btn--wd btn--xl">SHOP NOW</a> </div>
              </li>
              {/* SLIDE  */}
              <li data-transition="fade" data-slotamount={1} data-masterspeed={1000} data-saveperformance="off" data-title="Slide"> 
                {/* MAIN IMAGE */} 
                ...
                {/* LAYER NR. 4 */}
                <div className="tp-caption lfb ltt" data-x="center" data-y="center" data-voffset={100} data-speed={600} data-start={1100} data-easing="Power4.easeOut" data-endeasing="Power4.easeIn" style={{zIndex: 9}}><a href="#" className="btn btn--wd btn--xl">SHOP NOW</a> </div>
                {/* IMAGE NR. 1 */}
          ...
          <div className="scroll-to-content"> <a href="#" className="btn btn--round btn--round--lg"><span className="icon icon-arrow-down" /></a></div>
        </div>
      </section>
    );
